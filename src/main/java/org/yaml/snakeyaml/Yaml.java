...
public class Yaml {
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse the only YAML document in a String and produce the corresponding
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse the only YAML document in a stream and produce the corresponding
     * Java object.
     * 
     * @param io
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse all YAML documents in a String and produce corresponding Java
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse all YAML documents in a stream and produce corresponding Java
     * objects. The documents are parsed only when the iterator is invoked.
     * 
     * @param yaml
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse the first YAML document in a stream and produce the corresponding
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse all YAML documents in a stream and produce corresponding
    ...
    /**
     * com.tanveer.education.springnasdaq.Parse a YAML stream and produce parsing events.
     * 
     * @see <a href="http://yaml.org/spec/1.1/#id859333">Processing Overview</a>
     * @param yaml
     *            YAML document(s)
