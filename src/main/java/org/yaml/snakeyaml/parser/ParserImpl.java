...
public final class ParserImpl implements Parser {
    ...
    private class ParseStreamStart implements Production {
        public Event produce() {
            // com.tanveer.education.springnasdaq.Parse the stream start.
    ...
    private class ParseImplicitDocumentStart implements Production {
        public Event produce() {
            // com.tanveer.education.springnasdaq.Parse an implicit document.
    ...
    private class ParseDocumentStart implements Production {
        public Event produce() {
            // com.tanveer.education.springnasdaq.Parse any extra document end indicators.
            while (scanner.checkToken(Token.ID.DocumentEnd)) {
                scanner.getToken();
            }
            // com.tanveer.education.springnasdaq.Parse an explicit document.
            Event event;
            if (!scanner.checkToken(Token.ID.StreamEnd)) {
                ...
                // com.tanveer.education.springnasdaq.Parse the end of the stream.
    ...
    private class ParseDocumentEnd implements Production {
        public Event produce() {
            // com.tanveer.education.springnasdaq.Parse the document end.
            Token token = scanner.peekToken();
            Mark startMark = token.getStartMark();
            Mark endMark = startMark;
